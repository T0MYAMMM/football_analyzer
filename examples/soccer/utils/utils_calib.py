...
keypoint_world_coords_2D_raw = [[0., 0.], [52.5, 0.], [105., 0.], [0., 13.84], [16.5, 13.84], [88.5, 13.84], [105., 13.84],
...
keypoint_aux_world_coords_2D_raw = [[5.5, 0], [16.5, 0], [88.5, 0], [99.5, 0], [5.5, 13.84], [99.5, 13.84], [16.5, 24.84],
                                [88.5, 24.84], [16.5, 43.16], [88.5, 43.16], [5.5, 54.16], [99.5, 54.16], [5.5, 68],
                                [16.5, 68], [88.5, 68], [99.5, 68]]

line_world_coords_3D_raw = [[[0., 54.16, 0.], [16.5, 54.16, 0.]], [[16.5, 13.84, 0.], [16.5, 54.16, 0.]],
...
keypoint_world_coords_2D = [[x - 52.5, y - 34] for x, y in keypoint_world_coords_2D_raw]
keypoint_aux_world_coords_2D = [[x - 52.5, y - 34] for x, y in keypoint_aux_world_coords_2D_raw]
line_world_coords_3D = [[[x1 - 52.5, y1 - 34, z1], [x2 - 52.5, y2 - 34, z2]] for [[x1, y1, z1], [x2,y2,z2]] in line_world_coords_3D_raw]
...
def visualize_field():
    ...
    ax.scatter(keypoints_x, keypoints_y, color='blue', label='Key Points')

    # Draw the auxiliary key points
    aux_keypoints_x, aux_keypoints_y = zip(*keypoint_aux_world_coords_2D)
    ax.scatter(aux_keypoints_x, aux_keypoints_y, color='red', label='Auxiliary Key Points')

    # Draw the center circle
    center_circle = plt.Circle((0, 0), 9.15, color="green", fill=False)
    ax.add_patch(center_circle)

    # Set the field dimensions and labels
